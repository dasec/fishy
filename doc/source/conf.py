...
# -*- coding: utf-8 -*-
#
# fishy documentation build configuration file, created by
...
import os
import sys
sys.path.insert(0, os.path.abspath('../fishy'))
...
# ones.
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.graphviz', 'sphinxarg.ext']
...
man_pages = [
    (master_doc, 'fishy', 'fishy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'fishy', 'fishy Documentation',
     author, 'fishy', 'Toolkit for filesystem based hiding techniques',
     'Miscellaneous'),
]
